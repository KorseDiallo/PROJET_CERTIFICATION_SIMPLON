            ...
            <div class="login-box">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 card">
                        <br>
                        <h3 class="header-title">Faire Un Don </h3>
                        <form class="login-form" action="{{ route('payment.submit') }}" method="POST">
                            @csrf
                            <input type="hidden" name="product_name" value="Don pour Collecte de Fonds">
                            <div class="form-group">
                                <label for="amount">Montant</label>
                                <input type="number" name="price" class="form-control" placeholder="Montant" required>
                            </div>
                            <div class="form-group">
                                <label for="collecte_id">ID de la Collecte de Fonds</label>
                                <input type="number" name="collecte_id" class="form-control" placeholder="ID de la Collecte de Fonds" required>
                            </div>
                            <div class="form-group">
